...
SGpop_grouped
```
Split the Age group to the starting age and ending age of the age group and convert them to numeric.This is to enable the sorting of age group by starting age later.
