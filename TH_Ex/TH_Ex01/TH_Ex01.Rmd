...
description: |
  In this exercise, I learnt how to edit a web article by using distill for RMarkedown
author:
  - name: Zhang Jieyuan
...
First, let us import the data into R by using [*read_csv()*](https://readr.tidyverse.org/reference/read_delim.html)  of **readr** package.  
```{r}
